...
export default function Login() {
  ...
  // Hide eye button once password is validated — let Bootstrap's tick show cleanly
          ...
          <div className='mb-3'>
            <div className='form-floating' style={{ position: 'relative' }}>
              <input
                ...
                style={{
                  // Only add right padding for eye button when it's visible
                  paddingRight: passwordIsValid ? undefined : '3.2rem',
                }}
                onChange={() => {
                  setPasswordValidationClass('');
                  setShowPassword(false); // reset to hidden when user retypes
                  setError(null);
                }}
              />
              ...
              {/* Eye toggle — hidden once password is valid so Bootstrap tick shows cleanly */}
              {!passwordIsValid && (
                <button
                  type='button'
