        ...
        <form id='login-form' className='needs-validation' noValidate onSubmit={(e) => e.preventDefault()}>
          ...
          <div className='mb-3'>
            <div className='form-floating' style={{ position: 'relative' }}>
              ...
              {/* Eye toggle — sits inside the floating wrapper, right-aligned */}
              <button
                type='button'
                ...
                style={{
                  ...
                  zIndex: 10,
                  lineHeight: 1,
                  // Make sure it doesn't receive browser autofill overlay
                  pointerEvents: 'auto',
                }}
                tabIndex={-1}
              >
            ...
            <div className='modal-content'>
              ...
              <form onSubmit={handleForgotPassword}>
                <div className='modal-body pt-2'>
                  ...
                  {forgotResult && (
                    <div className={`alert alert-${forgotResult.alertColor} py-2 px-3 mb-0`} role='alert' style={{ fontSize: '0.875rem' }}>
