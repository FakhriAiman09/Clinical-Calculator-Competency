...
import { getRelevantFeedbackMarkdown, parseFeedbackObject } from '@/utils/report-feedback';
...
function PrintReportContent() {
  ...
  const [forceSelector] = useState(false);
  ...
  const buildReport = useCallback(async (student: Student, report: StudentReport) => {
    ...
    const built: EPAData[] = REPORT_EPAS.map((epaId) => {
      ...
      const relevantFeedback = getRelevantFeedbackMarkdown(feedbackObj, epaId, { transformText: annotateScores });
