        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <p className="text-muted small mb-0">
              ...
              academic purposes. It is designed to support clinical competency assessment in
              medical education settings. All data should be handled in accordance with
              institutional policies and applicable privacy regulations.
            </p>
